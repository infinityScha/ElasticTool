...
js1=(0 0.05 0.1 0.15 0.2 0.25 0.3 -0.05)
js1_prev=(basic_structure 0 0.05 0.1 0.15 0.2 0.25 0)
...
do
    ...
    nohup julia --threads=4 ForHeatmap.jl ${js1_prev[$i]} ${js1[$i]} 0 0 &>vary_curr_chi.log
