const MAIN_PATH = "results_domain2/basic_structure/"
...
rem_patches_open = vesicle_manuscript(Vupper_extra=0.1, Vwater=0.9, is_open = true, is_binary = true, Φ₀=0.1/1.1, Jₛᵘ=0.0, r_tot=50.0)[end]
rem_patches_bud = vesicle_manuscript(Vupper_extra=0.1, Vwater=0.9, is_open = false, is_binary = true, Φ₀=0.1/1.1, Jₛᵘ=0.0, r_tot=50.0)[end]
...
# set the spontaneous curvature to 1.0
change_patch_property(MAIN_PATH*"initial.vol_patches", 1, "JS_I", -0.1)
# load the state
