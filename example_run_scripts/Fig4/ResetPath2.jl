const MAIN_PATH = "results/mixed/path_reset2/"
...
coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/mixed/path_reset/states/5226/", M)
