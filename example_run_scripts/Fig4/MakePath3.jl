...
elseif WHICH_SYSTEM == "30"
    coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/20/path/final_path/", M)
    save_string(coords_arr, vol_patches_arr, rem_patches_arr, MAIN_PATH * "initial_path/")
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "JS_I", 0.4/3.0)
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "PHI0", 0.3)
elseif WHICH_SYSTEM == "40"
    coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/30/path/final_path/", M)
    save_string(coords_arr, vol_patches_arr, rem_patches_arr, MAIN_PATH * "initial_path/")
...
elseif WHICH_SYSTEM == "15"
    coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/40/path/final_path/", M)
    save_string(coords_arr, vol_patches_arr, rem_patches_arr, MAIN_PATH * "initial_path/")
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "JS_I", 0.4*0.1/0.15)
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "PHI0", 0.15)
elseif WHICH_SYSTEM == "5"
    coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/15/path/final_path/", M)
    save_string(coords_arr, vol_patches_arr, rem_patches_arr, MAIN_PATH * "initial_path/")
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "JS_I", 0.4*0.1/0.05)
    change_vol_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "PHI0", 0.05)
end
