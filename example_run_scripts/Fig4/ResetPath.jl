const MAIN_PATH = "results/mixed/path_reset/"
...
coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = load_string("results/mixed/path/initial_path_new/", M)
save_string(coords_arr, vol_patches_arr, rem_patches_arr, MAIN_PATH * "initial_path/")
# change resolution to 1 nm
change_rem_patch_property_in_string(MAIN_PATH * "initial_path/", M, 1, "RESOLUTION", 1.0)
change_rem_patch_property_in_string(MAIN_PATH * "initial_path/", M, 2, "RESOLUTION", 1.0)
change_rem_patch_property_in_string(MAIN_PATH * "initial_path/", M, 3, "RESOLUTION", 1.0)
change_rem_patch_property_in_string(MAIN_PATH * "initial_path/", M, 4, "RESOLUTION", 1.0)
...
# minimize the path
coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = neb_method(coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr, neb_coords_place_arr, initial_step_num = 0, initial_ΔEₘₐₓ=5.0e-1, final_ΔEₘₐₓ=1.0e-3, remesh_spacing=1, μᵥ=5.0e4, μᵩ=5.0e6, mult_val=0.999)
