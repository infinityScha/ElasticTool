const MAIN_PATH = "results/mixed/for_phi_dep/"
...
# minimize the path
coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr = neb_method(coords_arr, indep_coords_arr, vol_patches_arr, rem_patches_arr, neb_coords_place_arr, initial_step_num = 0, initial_ΔEₘₐₓ=5.0e-2, final_ΔEₘₐₓ=5.0e-4, remesh_spacing=1, μᵥ=5.0e4, μᵩ=5.0e6, mult_val=0.999, max_steps=150)
