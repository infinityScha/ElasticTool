...
plt.legend(fontsize=13, loc="lower left", ncol=1, frameon=false, borderaxespad=0.0, handletextpad=0.0, columnspacing=0.0, title="Upper leaflet \narea increase", title_fontsize=13)
