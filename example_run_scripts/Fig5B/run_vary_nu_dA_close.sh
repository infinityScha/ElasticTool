...
do
    ...
    nohup julia --threads=3 ForPhaseSpace.jl close ${nu_prev[$i]} ${nu[$i]} 2.2 2.2 > curr_close.log
done
...
do
    ...
    do
        ...
        nohup julia --threads=3 ForPhaseSpace.jl close ${nu[$i]} ${nu[$i]} ${dA_prev[$j]} ${dA[$j]} > curr_close.log
    done
done